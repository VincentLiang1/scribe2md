...
below-normal 好讓「電腦還能用」(2026-08-04 指定),而 **介面跟轉錄跑在
同一個行程裡**——於是介面也一起被降,滿載時停止鈕要 15~35 秒才有反應
(暖機期 95 秒,當時在 gradio 版上實測,記在 `docs/dev/ui.md`),使用者
等不到就以為程式死了(2026-08-07 實跡:連關兩次重來,而它一直好好地在跑)。
